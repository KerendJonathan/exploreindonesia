...
<head>
  ...
  gtag('config', 'G-S79Y2FRX1H');
    ...
    <meta name="title" content="About Us - Visit Indonesia">
    <meta name="description" content="Indonesia is a country located in Asia and has 17,001 islands.">
    <meta name="keywords" content="">
    <!-- Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://exploreindonesia.menjaditerang.com/about.php">
    <meta property="og:title" content="About Us - Visit Indonesia">
...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-hiking"></i> ExploreIndonesia </a>
...
<!-- <div class="content-area">
    ...
    <section class="our-team">
		<div class="container">
			...
			<p class="text-center text-muted">Passionate undergraduate IT team, eager to use our skills and knowledge to make a positive impact.</p>
			<br><br>
			<div class="row">
